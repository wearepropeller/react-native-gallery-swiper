	...
	componentWillMount() {
		...
		this.gestureResponder = createResponder({
			onStartShouldSetResponderCapture: (evt, gestureState) => {
				// console.log("tewter", gestureState);
				return this.props.images[this.currentPage].type === "image";
			},
			onStartShouldSetResponder: (evt, gestureState) => {
				return this.props.images[this.currentPage].type === "image";
			},
			onMoveShouldSetResponder: (evt, gestureState) => {
				// console.log("tewter2", gestureState);
				return (
					(this.props.images[this.currentPage].type === "video" && gestureState.moveX > 300) ||
					this.props.images[this.currentPage].type === "image"
				);
			},
